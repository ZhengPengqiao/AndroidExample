        ...
        mCaptureIv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isRecordOn) {
                    ...
                    Toast.makeText(RecordService.this.getApplicationContext(), "----"+Environment.getExternalStorageDirectory().getPath()+"--" , Toast.LENGTH_LONG).show();
